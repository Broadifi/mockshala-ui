  ...
  return (
    ...
    hover:bg-blue-500 hover:border-blue-500 hover:text-white transition-all duration-200"
      ...
      <div className="  flex-col sm:flex-none   items-center justify-center ">
        ...
        <div
          className="text-gray-600 min-[1028px]:text-lg md:text-base text-sm text-justify px-2     first-letter:float-left first-letter:text-5xl first-letter:font-bold first-letter:mr-2 first-letter:leading-none first-letter:uppercase"
