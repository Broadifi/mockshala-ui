                ...
                <div className="group flex flex-col rounded-3xl cursor-pointer shadow-sm hover:shadow-lg bg-card overflow-hidden   h-full pb-3">
                  ...
                  <div className="flex flex-wrap gap-1 px-4 py-2 lg:h-7 h-5 lg:pb-0 pb-5 max-[314px]:pb-8 min-[560px]:pb-8 max-[604px]:pb-8 ">
                    {item?.tags?.slice(0, 2).map((tagItem) => (
                      <div
                        key={tagItem}
                        className="flex items-center gap p-0 rounded-full  text-xs font-medium  bg-gray-100 pl-1.5"
                      >
                        <Tag  className="size-3.5" />
                        <Badge
                          variant="link"
                          className="text-title-gradient-blue  uppercase 2xl:text-xs text-[10px]"
                        >
                          {tagItem}
                        </Badge>
                      </div>
