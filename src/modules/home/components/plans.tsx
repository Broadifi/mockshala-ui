...
function Plans() {
  ...
  const studentPlan = plansData?.some((plan) => plan.isUnlimited === false);
      ...
      <div className="w-full container px-4 py-5 mx-auto space-y-12">
        ...
        {studentPlan && (
          <div>
            ...
            <div className="flex flex-wrap gap-8 md:gap-10 2xl:gap-15 w-full justify-center items-stretch">
              {plansData
