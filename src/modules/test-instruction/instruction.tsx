...
function Instruction() {
  ...
  const {examId}= useParams({from:'/$lang/instructions/$testSlug/$examId/'})
      ...
      <div className='bg-linear-to-r from-sky-100/30 to-blue-100/30 p-4 mb-4 border border-gray-400 rounded-lg space-y-4'>
        <div className='space-y-4 py-3'>
          ...
          <div className='bg-white p-3 rounded-2xl text-blue-700 font-semibold border border-gray-200 shadow-xs '>
            <p>
              Total Number of Question: <span className='text-black'>6</span>
            </p>
            <p className='text-green-800'>
              Total Available Time:{' '}
              <span className='text-black '>180 Minutes</span>
            </p>
          </div>
        </div>
        ...
        <div className='py-[10rem] '>
          <p>
            ...
            quisquam alias debitis nihil ducimus soluta ad fuga porro et
