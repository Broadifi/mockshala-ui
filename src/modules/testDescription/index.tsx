              ...
              <div>
                ...
                <div className="pb-8">
                  <p className="text-sm text-[#1e4064]  max-w-3xl">
                    ...
                    undergraduate programs in 200+ top Indian universities such
                    as DU, BHU, JNU, and AMU. With increasing competition in
                    2026, structured preparation through mock tests and practice
                    papers is essential.
                  </p>
                </div>
                ...
                <div className=" shadow-lg bg-white/80 rounded-2xl p-2 space-y-5">
                  ...
                  <div className="px-2">
                    ...
                    <div className="flex flex-col items-center mb-4">
                      <p className="text-3xl font-bold text-button-blue">
                        ₹700
                      </p>
